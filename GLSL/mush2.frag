...
void main() {
    ...
    float freq = 50.;
    float col = 1.0+(val-d*d2*d5*1000.)+(300.-d*d4*1000.)*cos(p.x*p.y*50.14+p.y*(45.+sin(t*0.24)*5.)+t);
    float col2 = 1.0+(val-d3*d2*d3*1000.)+(300.-d3*d2*1000.)*cos(p.x*p.y*50.14+p.y*(45.+sin(t*0.24)*5.)-t);
    float col3 = 1.0+(val-d6*d6*d6*1000.)+(300.-d5*d*1000.)*cos(p.x*p.y*50.14+p.y*(45.+sin(t*0.24)*5.)+t);
