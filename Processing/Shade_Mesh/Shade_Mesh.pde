...
void draw() {
  ...
  shader.set("brightness",0.575+0.25*sin(frameCount*0.01));//0.4);//
  shader.set("x_mod",frameCount*0.008);
  ...
  //pointLight(255,255,255,-165.6+(0.5+0.5*sin(frameCount*0.01))*380,-130.8+(0.5+0.5*cos(frameCount*0.01))*380,100);
